...
theme.MobileNav = (function() {
  ...
  function init() {
    ...
    // if (cache.mobileNavIconClose) {
    //   cache.mobileNavIconClose.addEventListener('click', toggleMobileNav);
    // }
  ...
  function cacheSelectors() {
    cache = {
      ...
      mobileNavIconClose: document.querySelector('.mobile-nav--close')
    };
  }
  ...
  function goToSubnav(target) {
    ...
    // cache.pageContainer.style.transform =
    //   'translateX(' + translateMenuHeight + 'px)';
...
theme.SearchResultsTemplate = (function() {
  ...
  function renderHeader(products, isLoading) {
    ...
    return [
      ...
      '<h3 id="predictive-search" class="predictive-search-title__content">SUGGESTIONS</h3>',
    ...
    _initAddToCart: function() {
      ...
      productForm.addEventListener(
        ...
        function(evt) {
          ...
          let productVariations = document.querySelector('.product-variant-grid')

          if (productVariations) {
            if (productVariations.classList.contains("noselection")) {
              evt.preventDefault();
              return false;
            }
          }
    ...
    _addItemToCart: function(form) {
      ...
      fetch('/cart/add.js', {
        ...
        .then(function(json) {
          ...
          if (location.search == "") {
            reloadOpenCart = location.href + "?opencart=true";
          } else {
            reloadOpenCart = location.href + "&opencart=true";
          }
          location.assign(reloadOpenCart)
          return;
        })
        .catch(function(error) {
...
theme.ProductRecommendations = (function() {
  console.log("our ProductRecommendations")
  function ProductRecommendations(container) {
    console.log("in ProductRecommendations")
